...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	  ...
	  dayLabel: _react.PropTypes.element,
	  ...
	  _createClass(CalendarDay, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        }, dayLabel ? dayLabel({ day: day }) : _react2['default'].createElement('span', { className: 'CalendarDay__day' }, day.format('D')));
	      }
